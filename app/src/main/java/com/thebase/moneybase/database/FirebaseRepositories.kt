...
//
//        fun listenToTransactions(userId: String, onUpdate: (List<Transaction>) -> Unit): ListenerRegistration {
...
//                }
//        }
//        fun listenToCategories(userId: String, onUpdate: (List<Category>) -> Unit): ListenerRegistration {
//            return db.collection("users")
//                .document(userId)
//                .collection("categories")
//                .addSnapshotListener { snapshot, error ->
//                    if (error != null || snapshot == null) {
//                        Log.e("Firestore", "Category listener failed", error)
//                        return@addSnapshotListener
//                    }
...
//        }
//
//        fun listenToWallets(userId: String, onUpdate: (List<Wallet>) -> Unit): ListenerRegistration {
//            return db.collection("users")
//                .document(userId)
//                .collection("wallets")
//                .addSnapshotListener { snapshot, error ->
//                    if (error != null || snapshot == null) {
//                        Log.e("Firestore", "Listen wallets failed", error)
//                        return@addSnapshotListener
//                    }
