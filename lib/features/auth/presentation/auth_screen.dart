...
class _AuthShowcase extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final gradient = LinearGradient(
      ...
      colors: [
        colors.primaryAccent.withOpacity(0.96),
        Color.lerp(colors.primaryAccent, colors.secondaryAccent, 0.45)!
            .withOpacity(0.94),
        colors.tertiaryAccent.withOpacity(0.9),
      ],
    );

    final shadowColor = colors.surfaceShadow.withOpacity(0.28);
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Balances, budgets, and insights in sync',
                  ...
                  const SizedBox(height: 28),
                  Text(
                    'Sign in to unlock your MoneyBase workspace with live analytics, shared shopping lists, and forecasting tuned to your goals.',
                    style: theme.textTheme.titleMedium?.copyWith(
                  ...
                  Wrap(
                    ...
                    children: const [
                      ...
                      _AuthHeroBadge(
                        ...
                        label: 'Smart cashflow forecasts',
                      ),
                      _AuthHeroBadge(
                        icon: Icons.groups_rounded,
                        label: 'Shared budgets & lists',
                      ),
                    ],
                  ),
                        ...
                        return Column(
                          ...
                          children: const [
                            ...
                            _AuthHighlightCard(
                              ...
                              value: '3',
                              subtitle: 'members tracking budgets together',
...
class _AuthHeroBadge extends StatelessWidget {
  const _AuthHeroBadge({required this.icon, required this.label});
